...
pub(crate) struct TurnContext {
    ...
    pub(crate) custom_user_instructions: Option<String>,
    pub(crate) project_doc_max_bytes: u64,
    pub(crate) project_doc_fallback_filenames: Vec<String>,
...
impl Session {
    async fn new(
        ...
        let turn_context = TurnContext {
            ...
            user_instructions,
            custom_user_instructions: config.user_instructions.clone(),
            project_doc_max_bytes: config.project_doc_max_bytes as u64,
        ...
        match sub.op {
            ...
            Op::OverrideTurnContext {
                ...
                let new_turn_context = TurnContext {
                    ...
                    custom_user_instructions: prev.custom_user_instructions.clone(),
                    project_doc_max_bytes: prev.project_doc_max_bytes,
                    project_doc_fallback_filenames: prev.project_doc_fallback_filenames.clone(),
            ...
            Op::UserTurn {
                ...
                if let Err(items) = sess.inject_input(items).await {
                    ...
                    let fresh_turn_context = TurnContext {
                        ...
                        project_doc_fallback_filenames: turn_context
...
async fn spawn_review_thread(
    ...
    let review_turn_context = TurnContext {
        ...
        custom_user_instructions: parent_turn_context.custom_user_instructions.clone(),
        project_doc_max_bytes: parent_turn_context.project_doc_max_bytes,
        project_doc_fallback_filenames: parent_turn_context.project_doc_fallback_filenames.clone(),
